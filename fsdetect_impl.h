...
/* gcc-4.8.4 has __BYTE_ORDER__, gcc-4.4.3 doesn't have it. */
#if defined(__i386) || (__BYTE_ORDER__ && __BYTE_ORDER__ == __ORDER_LITTLE_ENDIAN__)
  #define le32(x) ((uint32_t)(x))
  #define le16(x) ((uint16_t)(x))
  #define le8(x) ((uint8_t)(x))
  #define le(x) ((uint32_t)(x))
  ...
  #define le(x0) (sizeof(x0) == 1 ? le8(x0) : sizeof(x0) == 2 ? le16(x0) : le32(x0))
